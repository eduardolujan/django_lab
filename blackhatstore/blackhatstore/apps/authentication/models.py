# -*- coding: utf-8 -*-
__authors__ = [
    'Eduardo Lujan <eduardo.lujan.p@gmail.com>',
]
...
class Profile(models.Model):
    ...
    role = models.CharField(max_length=1, choices=USER_ROLE_CHOICES, default='N')
    ...
    natural_key.dependencies = ['authentication.user']
