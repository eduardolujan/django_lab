...
env.project_name = 'blackhatstore'
env.repository = 'git@github.com:lincolnloop/blackhatstore.git'
...
def dev():
    ...
    """
    server = 'blackhatstore.dev.lincolnloop.com'
    env.roledefs = {
        'web': [server],
        'db': [server],
    }
